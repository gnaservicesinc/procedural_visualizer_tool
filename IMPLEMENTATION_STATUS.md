...
are historical evidence, not the current support policy.
...
but a native ARM64 runner does not set CMake's cross-compiling flag. Qt 6.8
therefore searched for a target `qtpaths.exe`, missed the wrapper, and invoked
