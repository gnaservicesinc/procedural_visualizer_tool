...
std::vector<LiveTargetDescriptor> buildLiveTargetRegistry(
    ...
    for (const pvt::LayerConfig& authored_layer : project.layers) {
        ...
        add_nested(QStringLiteral("alpha.use_source"), QObject::tr("Use source alpha"),
                   QObject::tr("Alpha"), LiveTargetKind::Boolean, 0, 1,
        ...
        for (const pvt::EffectConfig& effect : render.effects) {
            ...
            add_effect(QStringLiteral("type"), QObject::tr("Effect type"), LiveTargetKind::Enumeration, 0, 10, static_cast<double>(effect.type), [](pvt::EffectConfig& e, double v) { e.type = static_cast<pvt::EffectType>(std::llround(v)); });
